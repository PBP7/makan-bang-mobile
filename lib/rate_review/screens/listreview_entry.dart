...
class ReviewEntryPage extends StatefulWidget {
  ...
  const ReviewEntryPage({super.key, required this.productId});
...
class _ReviewEntryPageState extends State<ReviewEntryPage> {
  Future<List<RateReviewEntry>> fetchReview(CookieRequest request, String productId) async {
    final response = await request.get('https://fariz-muhammad31-makanbang.pbp.cs.ui.ac.id/rate_review/product_detail/$productId/json/'); // INI 
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            rateReviewEntry.fields.user?.toString() ?? "Unknown User",
                                            style: TextStyle(
                                              fontSize: fontSize,
                                              fontWeight: FontWeight.bold,
                                              color: Colors.white,
